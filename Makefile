...
IMAGES_DOCKER_REPO := quay.io/kubotal/images
...
.PHONY: chart-yaml
chart-yaml: ## Generate the helm/kad-hive-metastore/Chart.yaml
	echo "$$CHART_YAML" >./helm/hive-metastore/Chart.yaml

.PHONY: chart
chart: chart-yaml ## Build and push helm chart
	cd ./helm && helm package -d ./../tmp hive-metastore && helm push ./../tmp/hive-metastore-0.1.0.tgz oci://${HELM_DOCKER_REPO}
